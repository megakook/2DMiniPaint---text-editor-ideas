...
var ntc_main = {
  ...
  init: function() {
    ...
    $("#colorpick").html("<select id=\"colorop\" class=\"colorop\"><option value=\"\">Select a Color:</option>" + clrop.join() + "</select>");
    ...
    $("#colorbox").click(ntc_main.showPopupColorPane);
    ntc_main.setWheel('#0000ff');
  },
  ...
  setColor: function(clr) {
    ...
    GUI.set_color(document.getElementById("colorbox"));
    var rgb = ntc.rgb(clr);

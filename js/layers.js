...
function LAYER_CLASS() {
	...
	this.generate_text_layer_name = function(prefix) {
		if(prefix == undefined)
			prefix = 'T';
		return prefix + ' #' + (text_layer_max_index);
	};
	...
	this.get_active_layer = function () {
		return document.getElementById(LAYER.layers[LAYER.layer_active].name);
	};

	this.send_canvas_front_to_back = function() {
		var parent = document.getElementById('canvas_wrapper');
		var content = document.getElementById('canvas_front');
		var target = document.getElementById('canvas_more');
		parent.insertBefore(content, target);
	};

	this.bring_canvas_front_to_front = function() {
		var parent = document.getElementById('canvas_wrapper');
		var target = document.getElementById('canvas_front');
		var content = document.getElementById('canvas_more');
		parent.insertBefore(content, target);
	};

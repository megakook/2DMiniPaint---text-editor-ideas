...
var DRAW_TOOLS_CONFIG = [
	{name: 'select_tool', 	title: 'Select object tool',	icon: ['sprites.png', 7, 2],	attributes: {}		},
	...
	{name: 'letters', 	title: 'Draw letters',		icon: ['sprites.png', -350+3, 4],	attributes: {type: 'Arial', type_values: ['Arial', 'Helvetica', 'Times New Roman', 'Times', 'Courier New', 'Courier', 'Verdana', 'Georgia', 'Palatino', 'Garamond', 'Bookman', 'Comic Sans MS', 'Trebuchet MS', 'Arial Black', 'Impact'], size: 16}, on_update: 'update_letter'},
